...
if __name__ == '__main__':
    ...
    conf = {
        ...
        'sasl.password': 'Endpoint=sb://prmongoeh.servicebus.windows.net/;SharedAccessKeyName=p1;SharedAccessKey=AwGKFE+N8BkQaJ0L+fJBd9lMrkyojnqAd7ZRKQWTHeI=;EntityPath=testhub',          #replace
        'group.id': group,
